...
public final class Base_de_Datos {
 ...
 private static Base_de_Datos instanciaBD = null;

 public Base_de_Datos() throws InstantiationException, IllegalAccessException {
        crearConexion();
    }
...
public void crearConexion() throws InstantiationException, IllegalAccessException {
    ...
    static public Base_de_Datos getConexion() throws InstantiationException, IllegalAccessException {

        if (instanciaBD == null) {
            instanciaBD = new Base_de_Datos();
        }
        return instanciaBD;
    }
