...
--
-- Servidor: localhost
-- Tiempo de generación: 24-11-2017 a las 14:57:44
...
-- Base de datos: `uresa`
--
CREATE DATABASE IF NOT EXISTS `uresa` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `uresa`;
...
(0, 'rapanui@hotmail.com', 'Rapa Nui', 'razon', 15928375, 1),
(1, 'Habana@gmail.com', 'Habana', 'rs', 15121212, 1),
(2, 'Arroyo@gmail.com', 'Frigorífico Arroyo', 'acbc', 1523212, 2),
(3, 'manush@gmail.com', 'Cervecería Manush', 'raz_soc', 15736459, 1),
(501, 'bolson@hotmail.com', 'Cervecería El bolson', 'razonsoc', 15766559, 2);
...
CREATE TABLE `establecimiento` (
  ...
  `nombre` varchar(45) DEFAULT NULL,
  `telefono` int(11) DEFAULT NULL,
  `archivos_adjuntos` varchar(45) NOT NULL,
...
(2, 'mitre 567', '2017-11-16', 'Chocolatería habana', 155023212, 'NULL', '101', '2017-11-11', 1, 1, 1, 3),
(4, 'san martin 123', '2017-11-16', 'Arroyo Carnes', 152322122, 'NULL', '100', '2017-11-11', 423, 2, 1, 3),
(38, 'elflein 54', '2017-11-23', 'Arroyo ahumados', 15212343, 'NULL', '102', '2017-11-02', 1234, 2, 2, 4),
(39, 'mitre 837', '2017-11-23', 'Manush Cervezas', 15234562, 'NULL', '103', '2017-11-02', 1232, 3, 1, 4),
(40, 'elordi 155', '2023-11-12', 'Heladería rapa nui', 15723455, 'NULL', '150', '2022-07-03', 12, 0, 1, 1),
(41, 'sarmiento 25', '2023-09-25', 'Cerveceria el bolson', 15212322, 'NULL', '156', '2022-10-09', 15, 501, 2, 4);
...
DROP TABLE IF EXISTS `establecimiento_has_rubro`;
...
--
-- Volcado de datos para la tabla `establecimiento_has_rubro`
--

INSERT INTO `establecimiento_has_rubro` (`Establecimiento_id`, `Rubro_id`) VALUES
(2, 1),
(40, 1),
(4, 2),
(38, 2),
...
DROP TABLE IF EXISTS `producto_alimenticio`;
...
DROP TABLE IF EXISTS `producto_alimenticio_has_envase`;
...
DROP TABLE IF EXISTS `producto_alimenticio_has_materia_prima`;
